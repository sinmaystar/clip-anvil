...
func (t *UpsertKeyElementsNativeTool) Info(context.Context) (*schema.ToolInfo, error) {
	return toolInfoFor[UpsertKeyElementsToolInput](toolUpsertElements, "创建、局部更新或替换 ClipAnvil 关键元素 KeyElement 及其视觉状态 KeyElementState。关键元素是视频一致性的锚点，包括商品、人物、场景、道具和风格参考。")
}
