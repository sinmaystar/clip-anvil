...
4. **React 前端** — Vite 8 + React 19 + `@xyflow/react` 画布入口
...
| 决策 | 原因 |
|---|---|
| `@xyflow/react` | React Flow 作为 Studio/Agent 共享画布交互层 |
| React 19 + Vite 8 + TypeScript 6 | 跟随当前稳定版，保持前端运行时与构建工具链统一 |
